...
public class App 
{
    ...
    public static void main(String[] args)
    {
        ...
        .withJar("s3n://"+bucketName+"/jarbucket/lastassi-1.0-SNAPSHOT.jar") // This should be a full map reduce application.
        .withMainClass("/com/assi3/step1.class")
        
        .withArgs("s3n://"+bucketName+"/input/BIARCS/", "s3n://"+bucketName+"/output/",NPmin,accessKey,secretKey,sessionToken);
        ...
        .withName("training classifier on hypernym relationship")
